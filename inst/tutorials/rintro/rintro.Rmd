...
For the first exercise, load the data into R (you can supply the function with the url in quotations "http://qss.princeton.press/student-files/INTRO/turnout.csv"). Hint: note that it is a .csv file. Store the data as an object called `turnout`.
